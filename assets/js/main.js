	...
	*/
	...
	function GameGridArea() {
		...
		(function __init__2__() {
			...
			celdCoords = getPatronCoords(patronName, centroGrid);
	...
	*/
	...
	function AutomataCelular() {
		...
		(function __init__() {
			...
			var initCoords = getPatronCoords(gameGridArea.getPatron(), centroGrid);
	...
	// Patrones
	function getPatronCoords(patron, centroGrid) {
		var cx = centroGrid.x;
		var cy = centroGrid.y;
		var coords = [];
